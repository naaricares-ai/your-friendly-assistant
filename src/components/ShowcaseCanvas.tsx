  ...
  return (
    <Float speed={1.5} rotationIntensity={0.2} floatIntensity={0.3}>
      <group ref={groupRef}>
        ...
        <mesh position={[-0.2, 1.25, 0.31]}><sphereGeometry args={[0.1, 16, 16]} /><meshStandardMaterial color="#00D4FF" emissive="#00D4FF" emissiveIntensity={3} /></mesh>
        <mesh position={[0.2, 1.25, 0.31]}><sphereGeometry args={[0.1, 16, 16]} /><meshStandardMaterial color="#00D4FF" emissive="#00D4FF" emissiveIntensity={3} /></mesh>
        <mesh position={[0, 0.3, 0]}><boxGeometry args={[1, 1.2, 0.6]} /><meshStandardMaterial color="#0a0a0c" metalness={0.95} roughness={0.05} /></mesh>
        <mesh position={[0, 0.4, 0.31]}><MeshDistortMaterial color="#7B61FF" distort={0.4} speed={3} emissive="#7B61FF" emissiveIntensity={1} /><sphereGeometry args={[0.18, 16, 16]} /></mesh>
      </group>
    </Float>
  );
}
  ...
  return (
    <Float speed={2} rotationIntensity={0.3} floatIntensity={0.5}>
      <mesh ref={meshRef}>
        ...
        <MeshDistortMaterial color="#00D4FF" distort={0.3} speed={2} roughness={0.1} metalness={0.9} emissive="#7B61FF" emissiveIntensity={0.2} />
      </mesh>
